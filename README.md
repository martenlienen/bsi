...
Copy the self-contained [`bsi.py`](bsi/bsi.py) module into your project and you are good to go. The following code snippet shows you to use the module with your own model and training code.
```python
import torch
